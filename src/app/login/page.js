    ...
    <div className="auth-wrapper">
      <div className="form-card" style={{ maxWidth: "28rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: "0.875rem" }}>Sign in to continue to your dashboard</p>
        </div>
        ...
        <p style={{ textAlign: "center", marginTop: "2rem", fontSize: "0.875rem", color: "var(--text-secondary)" }}>
          ...
          <Link href="/register" style={{ color: "var(--color-violet-light)", fontWeight: 500, textDecoration: "none" }}>
            Sign up
          </Link>
        </p>
      </div>
